...
const projects = [
  ...
  { slug: "prokub", title: "Прокуб", description: "B2B-платформа бетона с быстрым расчётом и заявками.", image: "/projects/real/prokub-desktop.webp", website: "https://prokub-rf.vercel.app/" },
  { slug: "profist", title: "Профист", description: "Каталог металлопроката с подбором под бизнес-задачу.", image: "/projects/real/profist-desktop.webp", website: "https://profist-rf.vercel.app/" },
  ...
  { slug: "boostmarine", title: "Boost Marine", description: "Сервисный сайт по ремонту водной техники.", image: "/projects/real/boostmarine-desktop.webp", website: "https://boostmarine.ru/" },
  { slug: "royal-horse", title: "Royal Horse", description: "Премиальная цифровая среда конно-спортивного комплекса.", image: "/projects/real/royal-horse-desktop.webp", website: "https://royal-horse-lake.vercel.app/" },
  { slug: "beef-flame", title: "Beefshteks", description: "Интерфейс доставки с быстрым сценарием заказа.", image: "/projects/real/beef-flame-desktop.webp", website: "https://beef-flame.vercel.app/" },
] as const;
