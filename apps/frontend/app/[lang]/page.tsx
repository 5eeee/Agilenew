...
const projectContent = {
  ...
  hy: { label: "Նախագծեր", intro: "Իրական գործարկված թվային նախագծեր՝ desktop և mobile կոմպոզիցիաներով։", items: [
    ...
    { slug: "royal-horse", title: "Royal Horse", label: "Hospitality", year: "2026", image: "/projects/real/royal-horse-desktop.jpg", url: "https://royal-horse-lake.vercel.app/", description: "Պրեմիում ձիասպորտի համալիրի արտահայտիչ բրենդային կայք։", features: ["Art direction", "Ադապտիվ", "Ամրագրում"], more: "Բացել կայքը" },
