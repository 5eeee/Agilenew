...
const pageCopy = {
  ...
  pl: { kicker: "Katalog / 2026", title: "Wybierz rozwiązanie według celu biznesowego", text: "Nie musisz znać stosu technologicznego. Powiedz, co ma się zmienić w sprzedaży lub procesach, a zaproponujemy najmniejszy skuteczny zakres projektu.", pricingTitle: "Jak powstaje wycena", market: "Pokazujemy przejrzyste budżety początkowe dla małego, doświadczonego zespołu. Po bezpłatnej konsultacji zakres można ograniczyć lub podzielić na etapy.", steps: ["Bezpłatnie omówimy wyzwanie", "Wybierz potrzebny zakres", "Zapisz projekt"] },
