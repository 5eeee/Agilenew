...
const pageCopy = {
  ru: { kicker: "Каталог / 2026", title: "Выбирайте решение по бизнес-задаче", text: "Не нужно заранее знать технический стек. Расскажите, что должно измениться в продажах или процессах, — мы предложим минимальный рабочий состав проекта.", market: "Показываем честный стартовый бюджет небольшой сильной команды. Финальный состав можно уменьшить или разбить на этапы после бесплатной консультации.", steps: ["Бесплатно разберём задачу", "Соберите нужное", "Сохраните проект"] },
  en: { kicker: "Catalogue / 2026", title: "Choose a solution by business outcome", text: "You do not need to know the technical stack. Tell us what should change in sales or operations and we will propose the smallest viable project scope.", market: "These are transparent starting budgets for a focused senior team. The final scope can be reduced or split into stages after a free consultation.", steps: ["Discuss the task for free", "Build the scope", "Save the project"] },
  ka: { kicker: "კატალოგი / 2026", title: "აირჩიეთ გადაწყვეტა ბიზნეს ამოცანის მიხედვით", text: "ტექნიკური სტეკის წინასწარ ცოდნა არ გჭირდებათ. გვითხარით, რა უნდა შეიცვალოს გაყიდვებში ან პროცესებში.", market: "ეს არის მცირე ძლიერი გუნდის გამჭვირვალე საწყისი ბიუჯეტი. უფასო კონსულტაციის შემდეგ პროექტი შეიძლება ეტაპებად დაიყოს.", steps: ["უფასო განხილვა", "შეარჩიეთ შემადგენლობა", "შეინახეთ პროექტი"] },
  hy: { kicker: "Կատալոգ / 2026", title: "Ընտրեք լուծումը բիզնես խնդրով", text: "Պետք չէ նախապես իմանալ տեխնոլոգիաները։ Ասեք՝ ինչ պետք է փոխվի վաճառքներում կամ գործընթացներում, և մենք կառաջարկենք նվազագույն աշխատող կազմը։", market: "Սրանք փոքր ուժեղ թիմի թափանցիկ մեկնարկային բյուջեներն են։ Անվճար խորհրդատվությունից հետո նախագիծը կարելի է բաժանել փուլերի։", steps: ["Անվճար քննարկում", "Ընտրեք կազմը", "Պահպանեք նախագիծը"] },
  bg: { kicker: "Каталог / 2026", title: "Изберете решение според бизнес целта", text: "Не е нужно да знаете технологиите предварително. Кажете какво трябва да се промени в продажбите или процесите.", market: "Това са прозрачни начални бюджети за малък силен екип. След безплатна консултация проектът може да се раздели на етапи.", steps: ["Безплатен разговор", "Изберете обхват", "Запазете проекта"] },
} as const;
