...
const copy = {
  ...
  pl: { title: "Zbuduj projekt dopasowany do potrzeb", intro: "Odpowiedz na kilka pytań, aby otrzymać realistyczny przedział budżetu i przekazać nam uporządkowane założenia.", steps: ["Rozwiązanie", "Rezultat", "Skala", "Funkcje", "Termin", "Kontekst"], questions: ["Co mamy stworzyć?", "Co powinno się zmienić po uruchomieniu?", "Jaka skala jest potrzebna w pierwszym etapie?", "Które funkcje są niezbędne?", "Kiedy potrzebna jest pierwsza działająca wersja?", "Opisz ważny kontekst projektu"], options: { website: "Strona lub serwis internetowy", crm: "CRM / panel klienta", automation: "Automatyzacja procesów", analytics: "BI i analityka", custom: "System dedykowany", leads: "Więcej zapytań", sales: "Wzrost sprzedaży", speed: "Sprawniejsze procesy", control: "Przejrzyste zarządzanie", launch: "Uruchomienie nowego produktu", starter: "MVP — najważniejsze funkcje", growth: "System gotowy na wzrost", scale: "Duża platforma", design: "Indywidualny projekt graficzny", integrations: "Integracje i API", account: "Panel klienta", payments: "Płatności i koszyk", dashboard: "Panele zarządcze", multilingual: "Wiele wersji językowych", calm: "Termin elastyczny", standard: "2–3 miesiące", urgent: "Przyspieszone uruchomienie" }, multi: "Możesz wybrać kilka opcji", continue: "Kontynuuj", placeholder: "Kto będzie korzystać z systemu, jakie procesy już działają i z czym należy go zintegrować?", estimate: "Wstępny przedział", contact: "Gdzie wysłać wycenę", name: "Imię i nazwisko", email: "E-mail służbowy", phone: "Telefon", send: "Wyślij wycenę", sending: "Wysyłanie…", success: "Wycena została wysłana. Skontaktujemy się w ciągu jednego dnia roboczego.", error: "Nie udało się wysłać wyceny. Sprawdź pola lub skontaktuj się z nami bezpośrednio.", note: "To orientacyjna wycena, a nie oferta handlowa. Zakres, etapy i budżet potwierdzamy po diagnozie." },
...
export function Calculator({ locale, labels }: { locale: Locale; labels: LegacyLabels }) {
  ...
  const format = (value: number) => new Intl.NumberFormat(locale === "ru" ? "ru-RU" : locale === "pl" ? "pl-PL" : "en-US").format(value);
