...
const copy = {
  ru: { eyebrow: "Ваш проект", title: "Корзина услуг", text: "Соберите услуги в один проект. После сохранения команда уточнит зависимости, этапы и итоговую смету.", empty: "Корзина пока пустая", emptyText: "Выберите готовые услуги в каталоге или рассчитайте индивидуальный проект.", catalogue: "Перейти к услугам", estimate: "Рассчитать проект", total: "Предварительный бюджет", clear: "Очистить", remove: "Удалить", checkout: "Сохранить проект", login: "Войдите, чтобы сохранить заказ. Этапы появятся в кабинете после подтверждения оплаты.", account: "Войти или зарегистрироваться", success: "Проект сохранён. Команда свяжется с вами, а этапы появятся в кабинете после оплаты.", open: "Открыть личный кабинет", note: "Оплата сейчас не списывается. Финальная стоимость фиксируется после короткой диагностики.", error: "Не удалось сохранить проект. Попробуйте ещё раз." },
  ...
  pl: { eyebrow: "Twój projekt", title: "Koszyk usług", text: "Połącz usługi w jeden projekt. Doprecyzujemy zależności, etapy i ostateczną wycenę.", empty: "Koszyk jest pusty", emptyText: "Wybierz usługi z katalogu lub wyceń projekt indywidualny.", catalogue: "Przejdź do usług", estimate: "Wyceń projekt", total: "Wstępny budżet", clear: "Wyczyść", remove: "Usuń", checkout: "Zapisz projekt", login: "Zaloguj się, aby zapisać zamówienie i śledzić jego etapy.", account: "Zaloguj się lub zarejestruj", success: "Projekt został zapisany. Zespół skontaktuje się, aby doprecyzować zakres.", open: "Otwórz panel klienta", note: "Na tym etapie nie pobieramy płatności. Ostateczną cenę potwierdzamy po diagnozie.", error: "Nie udało się zapisać projektu. Spróbuj ponownie." },
...
function formatPrice(price: number, locale: Locale) {
  return new Intl.NumberFormat(locale === "ru" ? "ru-RU" : locale === "pl" ? "pl-PL" : "en-US", { style: "currency", currency: "RUB", maximumFractionDigits: 0 }).format(price);
}
