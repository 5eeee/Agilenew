...
const projects: readonly ProjectSource[] = [
  ...
  { slug: "prokub", title: "Прокуб", category: "B2B platform", lead: "Прайс-платформа бетона с доставкой, быстрым расчётом и заявками.", tech: ["Next.js", "Calculator", "B2B UX", "SEO"], image: "/projects/real/prokub-desktop.webp", mobileImage: "/projects/real/prokub-mobile.webp", website: "https://prokub-rf.vercel.app/", year: "2026", featured: true },
  { slug: "profist", title: "Профист", category: "Industry", lead: "Каталог металлопроката с подбором продукции под конкретную бизнес-задачу.", tech: ["Product catalogue", "Lead generation", "UI system", "SEO"], image: "/projects/real/profist-desktop.webp", mobileImage: "/projects/real/profist-mobile.webp", website: "https://profist-rf.vercel.app/", year: "2026", featured: true },
